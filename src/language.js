const messages = {
  ...
  zh_TW: {
    ...
    team: {
      ...
      'member-1-introduce-1': '曾任綠界科技CryptoDT數位代幣平台區塊鏈工程師，區塊鏈技術信仰者，已投入區塊鏈領域研究1年以上。從事技術開發工作七年，曾參與美國前百大電商網站RWD開發以及宏碁、NEC、台灣之星、橘子支付等大型企業之專案開發。熟悉前端及後端多種開發語言及框架，擁有資訊安全、雲端建置等豐富經驗。',
      'member-1-introduce-2': '現致力於打造區塊鏈基礎建設以迎合未來趨勢。主要負責建構Spirit開發框架、SDK及資訊安全的實現。',
