const messages = {
  en_US: {
    ...
    // },
    // hero: {
    //   'title': 'SPIRIT - Mobile\'s DApp Develop Accelerator',
    ...
    //   'marketing': 'Marketing',
    //   'team': 'Team',
    //   'future-preserve': 'Futere Deserve',

    //   'token-sale-volume': 'Token Sale Volume:',
    //   'token-sale-volume-value': 'No cap',

    //   'distribution-of-tokens': 'Distribution of Tokens:',
    //   'distribution-of-tokens-value': 'For every 100 ICOS tokens sold through the ICO 20 additional tokens will be issued for distrubtion to partners, advisors, bounty participants, and the team members.',

    //   'token-price-at-issue': 'Token Price at Issue:',
    //   'token-price-at-issue-value': '0.008-0.012 BTC depending on the time of purchase',

    //   'public-presale-start-date': 'Public Presale Start Date:',
  ...
  zh_TW: {
    ...
    describe: {
      ...
      'content-3-1': 'Spirit DApp Store，是一個全新的去由社群驅動的手機DApp應用程式商店。',
      'content-3-2': '社群驅動符合區塊鏈去中心化的精神，我們相信社群將是未來的主流型態。Spirit團隊將運用區塊鏈技術與社群驅動力打造應用程式新型態。達成開發者、玩家社群、代幣持有者互惠互利的生態系統。',
      'content-3-3': '上架新DApp需經過社群投票決定，每款新推出的DApp能夠符合當時的市場需求及社群浪潮。我們也提出了貢獻及賞金獎勵計畫，Spirit 生態系的社群成員將會根據其對平台的貢獻得到相對應的獎勵，加速DApp Store平台的成長。',
    },
    detail: {
      'title': '特色',
