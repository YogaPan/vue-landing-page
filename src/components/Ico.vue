      ...
      <div class="l-row l-row--responsive">
          ...
          <div class="token__svg-wrapper">
            ...
            <svg class="token__svg" ref="svg">
              <circle
                ...
                class="hide"
                v-bind:class="{
                  active: this.activeState.tokenSale,
                  'is-in-view': this.isInView
                }"
                @mouseover="hover"
                r="100"
                cx="50%"
              ...
              <circle
                ...
                class="hide"
                v-bind:class="{
                  active: this.activeState.communityDevelop,
                  'is-in-view': this.isInView
                }"
                @mouseover="hover"
                r="100"
              ...
              <circle
                ...
                class="hide"
                v-bind:class="{
                  active: this.activeState.marketing,
                  'is-in-view': this.isInView
                }"
                @mouseover="hover"
                r="100"
              ...
              <circle
                ...
                class="hide"
                v-bind:class="{
                  active: this.activeState.futurePreserve,
                  'is-in-view': this.isInView
                }"
                @mouseover="hover"
                r="100"
          ...
          <ul class="token__list">
            ...
            <li>
              <div
                ...
                @mouseover="hover"
              >
                <span>{{ $t('ico.communityDevelop') }}</span>
                <span>40%</span>
              </div>
            </li>
            ...
            <li>
              <div
                ...
                @mouseover="hover"
              >
                <span>{{ $t('ico.futurePreserve') }}</span>
                <span>20%</span>
              </div>
            </li>
          </ul>
        ...
        <div class="ico__right">
          <table class="ico__table">
            <tbody>
              <tr>
                <td>{{ $t('ico.tokenSaleVolume.name') }}</td>
                <td>{{ $t('ico.tokenSaleVolume.value') }}</td>
              </tr>
              <tr>
                <td>{{ $t('ico.distributionOfTokens.name') }}</td>
                <td>{{ $t('ico.distributionOfTokens.value') }}</td>
              </tr>
              <tr>
                <td>{{ $t('ico.tokenPriceAtIssue.name') }}</td>
                <td>{{ $t('ico.tokenPriceAtIssue.value') }}</td>
              </tr>
              <tr>
                <td>{{ $t('ico.publicPresaleStartDate.name') }}</td>
                <td>{{ $t('ico.publicPresaleStartDate.value') }}</td>
              </tr>
              <tr>
                <td>{{ $t('ico.publicPresaleEndDate.name') }}</td>
                <td>{{ $t('ico.publicPresaleEndDate.value') }}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
.token {
  ...
  &__svg {
    ...
    circle {
      ...
      fill: none;
      cursor: pointer;
      transition: stroke-dasharray 0.5s 0.3s, stroke-width 0.3s;
    }
    circle.active {
      stroke-width: 40px;
    }
